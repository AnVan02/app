<template>
    <Page>
        <ActionBar title="Mới Phát Hành">
            <SearchBar hint="Nhập Tên Bài Hát" v-model="searchPhrase"
                @submit="onSearchSubmit" />
        </ActionBar>
        <GridLayout columns="*" rows="*,auto">
            <StackLayout col="0" row="0">
                <GridLayout columns="auto,*,auto" rows="auto,*,auto"
                    backgroundImage="~/assets/images/song-vn-2x.jpg"
                    height="100" class="album-image">
                    <Image src="~/assets/image/back.png" width="25"
                        height="25" col="0" row="0"
                        @tap="$navigateBack(HelloWorld)" />
                    <Label text=" " fontSize="14" fontWeight="bold"
                        color="red" col="2" row="0" />
                    <Label text="" fontSize="18" fontWeight="bold"
                        color="#7FFFD4" col="0" row="2" />
                </GridLayout>
                <SegmentedBar backgroundColor="LemonChiffon">
                    <SegmentedBarItem title="Trang Chủ" />
                    <SegmentedBarItem title="ZingChart" />
                    <SegmentedBarItem title="Nhạc Cá Nhân" />
                </SegmentedBar>
                ...
                <StackLayout col="0" row="1">
                    <GridLayout columns="*,*,*,*,*" rows="auto" height="60"
                        backgroundColor="#FFFF99">
                        <Image col="0" row="0" height="30" width="30"
                            margin="10" src="~/assets/images/trangchu.jpg" />
                        <Image col="1" row="0" height="30" width="30"
                            margin="10" src="~/assets/images/radio.jpg" />
                        <Image col="2" row="0" height="30" width="30"
                            margin="10" src="~/assets/images/qr.jpg" />
                        <Image col="3" row="0" height="30" width="30"
                            margin="10" src="~/assets/images/fl.jpg" />
                        <Image col="4" row="0" height="30" width="30"
                            margin="10" src="~/assets/images/scanhan.png" />
                    </GridLayout>
                </StackLayout>
        </GridLayout>
    </Page>
...
<script>
    import Appnghenhac from "./Appnghenhac";
            ...
            return {
                ...
                listViewData: [{
                    ...
                    },
                    {
                        ...
                        artist: "POST MALONE",
                        year: "2020",
                        imageUrl: "~/assets/images/better.jpg",
                        webSrc: "https://www.youtube.com/watch?v=SzJGzJSetOk"
                    }
                ]
            };
        }
